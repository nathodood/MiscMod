...
public class EntityTenTNTPrimed extends Entity {
	private int fuse, power;

	private static final DataParameter<Integer> FUSE = EntityDataManager.<Integer>createKey(EntityTenTNTPrimed.class,
			DataSerializers.VARINT);

	public EntityTenTNTPrimed(World world) {
		super(world);
	}

	public EntityTenTNTPrimed(World world, BlockPos pos, int fuse, int power) {
		this(world);
